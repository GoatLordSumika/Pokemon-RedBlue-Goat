...
; Pallet Town events
	...
	const EVENT_SET_FINAL_BATTLE_MUSIC
	const_skip 16
...
; Celadon City events
	...
	const EVENT_GOATLORD_LINKING_CORD
	const_skip 23
...
; Route 3 events
	const_next $3E0
	const EVENT_MET_ROUTE_2_GOATLORD 			; Custom Route 2 event
	const EVENT_BEAT_ROUTE_2_GOATLORD 			; Custom Route 2 event
...
; Route 10 events
	...
	const EVENT_BEAT_ROUTE_10_GOATLORD			;Custom Route 10 event
	const_skip
